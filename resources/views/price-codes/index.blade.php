...
@section('content')
{!! Form::open(['method' => 'GET', 'route' => ['price-code.index'], 'id' => 'search_form']) !!}
{!! Form::close() !!}
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-right">
                        ...
                        <a href="#" title="delete" class="btn-delete" data-id="{{$price_code->id}}"><i class="fas fa-trash-alt text-danger mx-1"></i></a>
                        @endcan
                    </td>
                </tr>
                @endforeach
...
<script>
    $(function() {
        ...
        $('body').on('click', '.btn-delete', function(e) {
            e.preventDefault();
            var id = $(this).data('id');
            Livewire.emit('setDeleteModel', 'PriceCode', id);
