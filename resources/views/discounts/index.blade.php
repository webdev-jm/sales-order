...
@section('content')
{!! Form::open(['method' => 'GET', 'route' => ['discount.index'], 'id' => 'search_form']) !!}
{!! Form::close() !!}
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-right">
                        ...
                        @endcan
                        @can('discount delete')
                            <a href="#" title="delete" class="btn-delete" data-id="{{$discount->id}}"><i class="fas fa-trash-alt text-danger mx-1"></i></a>
                        @endcan
                    </td>
                </tr>
                @endforeach
