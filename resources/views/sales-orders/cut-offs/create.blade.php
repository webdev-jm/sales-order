                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            {!! Form::date('start_date', '', ['class' => 'form-control'.($errors->has('start_date') ? ' is-invalid' : ''), 'form' => 'add_cut_off']) !!}
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            {!! Form::time('start_time', '', ['class' => 'form-control'.($errors->has('start_time') ? ' is-invalid' : ''), 'form' => 'add_cut_off']) !!}
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            {!! Form::date('end_date', '', ['class' => 'form-control'.($errors->has('end_date') ? ' is-invalid' : ''), 'form' => 'add_cut_off']) !!}
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            {!! Form::time('end_time', '', ['class' => 'form-control'.($errors->has('end_time') ? ' is-invalid' : ''), 'form' => 'add_cut_off']) !!}
