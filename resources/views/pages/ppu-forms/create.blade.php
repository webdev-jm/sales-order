...
<div class="card">
    <div class="card-header bg-black card-danger card-outline">
        <div class="row">
            <div class="col-12 col-sm-6 col-md-3">
                @if($logged_account->account->company_id == 1)
                <img src="{{asset('/images/bevi-logo-white (1).png')}}" alt="logo" height="60px"> 
                @elseif($logged_account->account->company_id == 2)
       ...
       <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    {!! Form::text('ship_to_name', session('ship_to_name') ?? $logged_account->account->account_name, ['class' => 'form-control form-control-sm bg-white'.($errors->has('ship_to_name') ? ' is-invalid' : ''), 'form' => 'add_ppu', 'readonly']) !!}
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    {!! Form::text('control_number', session('control_number') ?? $control_number, ['class' => 'form-control form-control-sm bg-white'.($errors->has('control_number') ? ' is-invalid' : ''), 'form' => 'add_ppu', 'readonly']) !!}
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    {!! Form::text('fullName', session('fullName') ?? $logged_account->user->fullName(), ['class' => 'form-control form-control-sm bg-white'.($errors->has('name') ? ' is-invalid' : ''), 'readonly']) !!}
                </div>
            </div>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    {!! Form::date('date_submitted', session('date_submitted') ?? '', ['class' => 'form-control form-control-sm'.($errors->has('date_submitted') ? ' is-invalid' : ''), 'form' => 'add_ppu']) !!}
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    {!! Form::date('date_prepared', session('date_prepared') ?? now(), ['class' => 'form-control form-control-sm bg-white'.($errors->has('date_prepared') ? ' is-invalid' : ''), 'form' => 'add_ppu', 'readonly']) !!}
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    {!! Form::date('pickup_date', session('pickup_date') ?? '', ['class' => 'form-control form-control-sm'.($errors->has('pickup_date') ? ' is-invalid' : ''), 'form' => 'add_ppu']) !!}
    ...
    <div class="card-footer">
        <div class="col-md-12 text-right">
                {!! Form::submit('Save as Draft', ['class' => 'btn btn-secondary btn-submit', 'form' => 'add_ppu']) !!}

                <button type="button" id="reviewOrderBtn" class="btn btn-primary">Review</button>

                {!! Form::hidden('status', 'draft', ['form' => 'add_ppu', 'id' => 'status']) !!}
        </div>
    </div>
</div>
