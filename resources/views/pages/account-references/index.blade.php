...
<div class="row">
    <div class="col-md-6">
        <h1>Account Product References</h1>
    </div>
    <div class="col-md-6 text-right">
        @can('account reference create')
        <a href="{{route('account-reference.create')}}" class="btn btn-primary"><i class="fas fa-plus mr-1"></i>Add Account Product References</a>
...
@section('content')
{!! Form::open(['method' => 'GET', 'route' => ['account-reference.index'], 'id' => 'search_form']) !!}
{!! Form::close() !!}

<div class="card">
    <div class="card-header">
        <h3 class="card-title">List of Account Product References</h3>
        ...
        <table class="table table-hover text-nowrap table-sm">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-right">
                        @can('account reference edit')
                            <a href="{{route('account-reference.edit', $account_reference->id)}}" title="edit"><i class="fas fa-edit text-success mx-1"></i></a>
                        @endcan
                        @can('account reference delete')
                            <a href="#" title="delete" class="btn-delete" data-id="{{$account_reference->id}}"><i class="fas fa-trash-alt text-danger mx-1"></i></a>
                        @endcan
                    </td>
                </tr>
                @endforeach
    ...
    <div class="card-footer">
        {{$account_product_references->links()}}
    </div>
</div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Upload Account Product References</h4>
            </div>
            <div class="modal-body">
                {!! Form::open(['method' => 'POST', 'route' => ['account-reference.upload'], 'id' => 'upload_form', 'enctype' => 'multipart/form-data']) !!}
                {!! Form::close() !!}
...
<script>
    $(function() {
        ...
        $('body').on('click', '.btn-delete', function(e) {
            e.preventDefault();
            var id = $(this).data('id');
            Livewire.emit('setDeleteModel', 'AccountProductReference', id);
