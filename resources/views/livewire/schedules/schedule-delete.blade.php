            ...
            @if(!empty($schedules))
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <p>
                                ...
                                @php
                                    $approval = $approvals->where('status', 'for deletion')->first();
                                @endphp
                            ...
                            @elseif($action == 'approve')
                                <div class="col-12">
                                    <form wire:submit.prevent="submitApprove">
                                        <div class="col-12">
                                            <p>
                                                <b>Are you sure to delete this schedule?</b>
                                            </p>
                                        </div>
                                        <div class="col-lg-12 mt-2">
                                            <button class="btn btn-default" wire:click.prevent="cancel" wire:loading.attr="disabled"><i class="fa fa-arrow-left mr-1"></i>Cancel</button>
                ...
                @else
                    <div class="list-group">
                        ...
                        <a href="#" class="list-group-item list-group-item-action" wire:click.prevent="viewDetail({{$schedule->id}})" wire:loading.attr="disabled">
