    ...
    <div class="modal-body">
        ...
        @if($is_on_leave)
            <div class="alert alert-danger text-center py-3 mb-3">
                ...
                <strong>VACATION LEAVE</strong> — No schedules for this date.
            </div>
        @endif
            ...
            <div class="row">
                <div class="col-12">
                    <p class="text-muted text-uppercase mb-0">
                        <i class="fa fa-user mr-1"></i>{{$schedule_data->user->fullName()}}
                    </p>
                    <h4 class="font-weight-bold">
                        {{ $schedule_data->branch ? '[' . $schedule_data->branch->branch_code . '] ' . $schedule_data->branch->branch_name : 'On Leave' }}
                    </h4>
                    <p class="mb-0">
                        <span class="text-muted">Objective</span><br>
