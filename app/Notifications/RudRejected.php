...
class RudRejected extends Notification
{
    use Queueable;
    use GlobalTrait;
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
            ...
            ->subject('RUD has been rejected.')
            ->greeting('Hello! '.$notifiable->fullName())
            ->line('RUD has been rejected by '.$this->approval->user->fullName())
