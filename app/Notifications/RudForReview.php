...
class RudForReview extends Notification
{
    use Queueable;
    use GlobalTrait;
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
            ...
            ->subject('RUD has been reviewed and is now for approval.')
            ->greeting('Hello! '.$notifiable->fullName())
            ->line('RUD is now for approval reviewed by '.$this->approval->user->fullName())
    ...
    public function toArray($notifiable)
    {
        return [
            ...
            'status_code' => 'primary',
            'message' => 'RUD has been reviewed and is now for approval.',
            'color' => 'primary',
