...
class RudApproved extends Notification
{
    use Queueable;
    use GlobalTrait;
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
            ...
            ->subject('RUD has been approved.')
            ->greeting('Hello! '.$notifiable->fullName())
            ->line('RUD has been approved by '.$this->approval->user->fullName())
