...
class ChartBusinessUnit extends Component
{
    ...
    public function mount() {
        ...
        $this->chart_data = $this->fetchData('chart-business-unit', 'POST');
    }

    public function render()
    {
        return view('livewire.sales-dashboard.chart-business-unit');
    }
}
