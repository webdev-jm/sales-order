...
class TableSalesVolumeBeva extends Component
{
    public $api_data;
    ...
    public function fetchData() {
        ...
        try {
            $client = new Client();
            $response = $client->post('http://127.0.0.1:8000/api/table-beva-sales-volume', [
                'headers' => $headers,
                'json' => $data,
            ]);
    ...
    {
        return view('livewire.sales-dashboard.table-sales-volume-beva');
    }
}
