...
class ChartSalesVsTarget extends Component
{
    ...
    public function mount() {
        ...
        $this->chart_data = $this->fetchData('chart-sales-vs-target', 'POST');
    }

    public function render()
    {
        return view('livewire.sales-dashboard.chart-sales-vs-target');
    }
}
